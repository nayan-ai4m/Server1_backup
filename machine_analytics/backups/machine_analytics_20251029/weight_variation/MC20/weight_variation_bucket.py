...
class CombinedAnalyzer:
    ...
    def fetch_latest_filling_stroke(self):
        try:
            ...
            SELECT
            timestamp,
            mc20->>'HMI_Filling_Stroke_Deg' as filling_stroke_deg
            FROM loop3_checkpoints
            WHERE
            timestamp >= NOW() - INTERVAL '7 days'
            AND mc20->>'HMI_Filling_Stroke_Deg' IS NOT NULL
            ), ranked_data AS (
            SELECT
            timestamp,
            filling_stroke_deg,
    ...
    def handle_underweight_detection(self):
        ...
        try:
            ...
            update_query = """UPDATE mc20_tp_status SET tp67 = '{}' """.format(tp_data)
    ...
    def handle_overweight_detection(self):
        ...
        try:
            ...
            update_query = """UPDATE mc20_tp_status SET tp66 = '{}' """.format(tp_data)
            cursor_tp.execute(update_query)
            self.hul_tp_conn.commit()
            # Flag Management
