...
class CombinedAnalyzer:
    def __init__(self):
        try:
            ...
            # Database connection parameters for mc18_tp_status (192.168.1.168)
    ...
    def handle_underweight_detection(self):
        ...
        try:
            ...
            # Status Update (UPDATE mc18_tp_status)
            tp_data = json.dumps({
            ...
            update_query = """UPDATE mc18_tp_status SET tp67 = '{}' """.format(tp_data)
    ...
    def handle_overweight_detection(self):
        ...
        try:
            ...
            update_query = """UPDATE mc18_tp_status SET tp66 = '{}' """.format(tp_data)
            cursor_tp.execute(update_query)
            self.tp_status_conn.commit()
