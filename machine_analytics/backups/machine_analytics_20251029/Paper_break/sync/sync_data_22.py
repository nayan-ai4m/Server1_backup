...
def insert_into_sync_data(spare1, vs_hs_sync, vs_hs_avg, vs_rv_sync, vs_rv_avg,
    ...
    insert_query = """
    INSERT INTO sync_data_22 (spare1, vertical_horizontal_sync, vertical_horizontal_sync_avg,
...
def main():
    ...
    print("Starting synchronization analysis for machine 22...")
    while True:
        try:
            latest_spare1 = get_latest_spare1()
            if latest_spare1 is None:
                print("No data found in mc22_short_data. Waiting...")
                time.sleep(1)
                continue
