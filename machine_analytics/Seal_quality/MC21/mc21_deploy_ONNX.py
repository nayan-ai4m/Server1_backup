...
class promis_mc21:
    def __init__(self):
        ...
        with open('/home/ai4m/develop/machine_analytics/Seal_quality/MC21/MC21_seal_quality_deployment/mc21_seal_strength_scaler.pkl', 'rb') as f:
    ...
    def predict_class(self,averaged_data):
        ...
        response = self.client.infer(model_name="Seal_mc21", inputs=[inputs], outputs=[outputs])
    ...
    def update_seal_strength(self,spare1, prediction):
        ...
        update_query = """UPDATE mc21 SET spare2 = %s WHERE spare1 = %s AND timestamp IN (SELECT timestamp FROM mc21 ORDER BY timestamp DESC LIMIT 100);"""
    ...
    def get_latest_spare1(self):
        ...
        cursor = conn.cursor()
        query = "SELECT spare1 FROM mc21_short_data ORDER BY timestamp DESC LIMIT 1;"
        cursor.execute(query)
