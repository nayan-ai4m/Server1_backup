...
class DataTransferManager:
    def __init__(self, table_name):
        ...
        # Remove '_fast' from table_name to construct target_table
        self.target_table = table_name.replace('_fast', '') + '_short_data'
    ...
    def run_continuously(self, interval_seconds=0.005):
...
def run_all_transfers():
    ...
    tables = ['mc25_fast', 'mc26_fast', 'mc27_fast', 'mc28_fast', 'mc29_fast', 'mc30_fast']
    managers = []
    threads = []
    ...
    try:
        ...
        for table in tables:
            ...
            thread = threading.Thread(target=manager.run_continuously, args=(0.005,))
            thread.daemon = True
