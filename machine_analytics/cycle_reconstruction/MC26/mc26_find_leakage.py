...
class ThresholdMonitor:
    ...
    def query_and_analyze(self):
        ...
        try:
            ...
            LIMIT 10;
            """
            current_query = """select timestamp,hor_temp_28_pv_front as front_current_value,hor_temp_28_pv_rear as rear_current_value from mc26_mid order by timestamp desc limit 1;"""
