...
if __name__ == "__main__":
    ...
    cam_stream = Reconnecting_CamGear(
        cam_address="rtsp://admin:unilever2024@192.168.1.24:554/Streaming/Channels/102",
        reset_attempts=2000,
        reset_delay=5,
    )


    stream = Stream("loop3_taping", size=(1280, 720), quality=50, fps=20)

    server = MjpegServer("192.168.0.158", 3005)
