...
class JAMMING_TP:
    ...
    def ensure_tp_column_exists(self, tp_table, tp_column):
        """
        Checks if the given column exists in the specified tp_status table and adds it if not.
                ...
                for machine in self.machines:
                    ...
                    if flag is not None and prev_flag != flag and current_timestamp is not None and refer_timestamp != current_timestamp:
                        ...
                        if is_problem:
                            ...
                            print(data)
                            # Insert event data into event_table on host 100.96.244.68
                            self.cursor_events.execute(self.insert_event_query, data)
                            self.conn_events.commit()

                        # Update tp_status table on host 100.103.195.124
