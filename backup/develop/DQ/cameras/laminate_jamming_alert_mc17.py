...
class JAMMING_TP:
    def __init__(self):
        ...
        self.update_tp_query_cont = f"UPDATE mc17_tp_status SET tp54 = %s;"
        ...
        self.update_tp_query_abrupt = f"UPDATE mc17_tp_status SET tp55 = %s;"
    ...
    def ensure_tp_column_exists(self, tp_column):
        ...
        Args:
            tp_column (str): Name of the column to check or add (e.g., 'tp51').
        """
        try:
            ...
            try:
                ...
                if flag is not None and prev_flag != flag and current_timestamp is not None and refer_timestamp!=current_timestamp:
                    ...
                    if elapsed >= timedelta(minutes=5):
                        print("Previous Event occured for 5 Mins")
