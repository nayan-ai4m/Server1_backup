...
logger = logging.getLogger("loop3_sku_writer")
...
def main():
    plc_ip = '141.141.142.11'  # PLC IP from your code
    tag_name = 'MX02_Batch_SKU'  # Tag to write to
    value_to_write = 'SSP1RSSF68810922'  # Specific value to write
